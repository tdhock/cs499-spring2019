...
- 10 points for accuracy of your code
...
- 10 points for not waiting until the last minute,
  ...
  - First week: 5 points if you have written all R functions by Fri Feb 22.
  - Second week: 5 more points if you have written all R tests and documentation, and have started your report by Fri Mar 1.
  - Third week: finish report vignette, make sure package passes R CMD check with no WARNING/ERROR on win-builder.
Extra credit:
  ...
  - 2-6 points extra credit if, in your Rmd report,
    ...
    in order to demonstrate that LMLogisticLossL2CV is more accurate. (2 points per data set)
