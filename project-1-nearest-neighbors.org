...
- Write up your results in vignettes/report.Rmd that shows the R code that you used
  ...
  - Documentation: [Vignettes chapter of R packages book](http://r-pkgs.had.co.nz/vignettes.html).
  - Example [Rmd vignette source code](https://github.com/cran/glmnet/blob/master/vignettes/glmnet_beta.Rmd),
    [vignette rendered to HTML](https://web.stanford.edu/~hastie/glmnet/glmnet_alpha.html).
